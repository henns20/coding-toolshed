...
describe('ngViewport', function () {
  ...
  it('should warn when instantiating a components with no controller', function () {
  ...
  it('should not activate a components when canActivate returns false', function () {
    var spy = jasmine.createSpy('activate');
    registerComponent('activate', '', {
  ...
  it('should not activate a components when canActivate returns a rejected promise', inject(function ($q) {
    var spy = jasmine.createSpy('activate');
    registerComponent('activate', '', {
  ...
  it('should activate a components when canActivate returns true', function () {
    var spy = jasmine.createSpy('activate');
  ...
  it('should activate a components when canActivate returns a resolved promise', inject(function ($q) {
    var spy = jasmine.createSpy('activate');
    registerComponent('activate', 'hi', {
...
describe('ngViewport animations', function () {
  ...
  it('should work in a simple case', function () {
    ...
    // "user pete" components enters
    item = $animate.queue.shift();
    expect(item.event).toBe('enter');
    expect(item.element.text()).toBe('hello pete');

    // "user brian" components leaves
    item = $animate.queue.shift();
