...
function makeComponentString(name) {
  return [
    '<router-components components-name="', name, '">',
    '</router-components>'
  ].join('');
}
 ...
 *     $router.config({ path: '/user/:id' components: 'user' });
 ...
 *
 * The default behavior is to dasherize and serve from `./components`. A components called `myWidget`
...
function $componentLoaderProvider() {
  ...
  return {
     ...
     * @description takes a function for mapping components names to components controller names
     */
    ...
    /**
     * @name $componentLoaderProvider#setCtrlNameMapping
     * @description takes a function for mapping components controller names to components names
     */
     ...
     * @description takes a function for mapping components names to components template URLs
     */
