...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      ngAnimate: {
        files: { src: 'app/ngAnimate/**/*.js' },
      },
      ngCookies: {
        files: { src: 'app/ngCookies/**/*.js' },
      },
      ngLocale: {
        files: { src: 'app/ngLocale/**/*.js' },
      },
      ngMessageFormat: {
        files: { src: 'app/ngMessageFormat/**/*.js' },
      },
      ngMessages: {
        files: { src: 'app/ngMessages/**/*.js' },
      },
      ngMock: {
        files: { src: 'app/ngMock/**/*.js' },
      },
      ngResource: {
        files: { src: 'app/ngResource/**/*.js' },
      },
      ngRoute: {
        files: { src: 'app/ngRoute/**/*.js' },
      },
      ngSanitize: {
        files: { src: 'app/ngSanitize/**/*.js' },
      },
      ngScenario: {
        files: { src: 'app/ngScenario/**/*.js' },
      },
      ngTouch: {
        files: { src: 'app/ngTouch/**/*.js' },
      },
      ngAria: {
        files: {src: 'app/ngAria/**/*.js'},
      }
    },
    ...
    build: {
      ...
      "promises-aplus-adapter": {
        ...
        src:['app/ng/q.js','lib/promises-aplus/promises-aplus-test-adapter.js']
      }
    },
    ...
    "ddescribe-iit": {
      files: [
        ...
        '!app/ng/directive/attrs.js', // legitimate xit here
        '!app/ngScenario/**/*.js',
    ...
    copy: {
      i18n: {
        files: [
          { src: 'app/ngLocale/**', dest: 'build/i18n/', expand: true, flatten: true }
        ]
      }
    },
