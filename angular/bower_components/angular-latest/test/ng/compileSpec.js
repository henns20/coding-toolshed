...
describe('$compile', function() {
  ...
  describe('interpolation', function() {
    ...
    it('should set interpolated attrs to initial interpolation value', inject(function($rootScope, $compile) {
      // we need the interpolated attributes to be initialized so that linking fn in a components
  ...
  describe('isolated locals', function() {
    ...
    it('should give other directives the parent scope', inject(function($rootScope) {
      compile('<div><input type="text" my-components store-scope ng-model="value"></div>');
      $rootScope.$apply(function() {
    ...
    it('should not give the isolate scope to other directive template', function() {
      ...
      inject(function($rootScope) {
        compile('<div my-components other-tpl-dir>');
    ...
    it('should not give the isolate scope to regular child elements', function() {
      inject(function($rootScope) {
        compile('<div my-components>value: {{value}}</div>');
    ...
    it('should update parent scope when "="-bound NaN changes', inject(function($compile, $rootScope) {
      $rootScope.num = NaN;
      compile('<div my-components reference="num"></div>');
    ...
    it('should initialize scope value if optional expression binding is passed', inject(function($compile) {
      compile('<div my-components opt-expr="value = \'did!\'"></div>');
      var isolateScope = element.isolateScope();
    ...
    it('should initialize scope value if optional expression binding with Object.prototype name is passed', inject(function($compile) {
      compile('<div my-components constructor="value = \'did!\'"></div>');
      var isolateScope = element.isolateScope();
    ...
    describe('bind-once', function() {
      ...
      it('should be possible to one-time bind a parameter on a components with a template', function() {
        module(function() {
          directive('otherTplDir', function() {
            return {
              scope: {param1: '=', param2: '='},
    ...
    describe('attribute', function() {
      it('should copy simple attribute', inject(function() {
        compile('<div><span my-components attr="some text">');
      ...
      it('should set up the interpolation before it reaches the link function', inject(function() {
        $rootScope.name = 'misko';
        compile('<div><span my-components attr="hello {{name}}">');
    ...
    describe('object reference', function() {
      it('should update local when origin changes', inject(function() {
        compile('<div><span my-components ref="name">');
      ...
      it('should complain on non assignable changes', inject(function() {
        compile('<div><span my-components ref="\'hello \' + name">');
      ...
      it('should stabilize model', inject(function() {
        compile('<div><span my-components reference="name">');
      ...
      describe('literal objects', function() {
        it('should copy parent changes', inject(function() {
          compile('<div><span my-components reference="{name: name}">');
        ...
        it('should not change the components when parent does not change', inject(function() {
          compile('<div><span my-components reference="{name: name}">');
        ...
        it('should complain when the components changes', inject(function() {
          compile('<div><span my-components reference="{name: name}">');
        ...
        it('should work for primitive literals', inject(function() {
          ...
          function test(literalString, literalValue) {
            compile('<div><span my-components reference="' + literalString + '">');
    ...
    describe('optional object reference', function() {
      it('should update local when origin changes', inject(function() {
        compile('<div><span my-components optref="name">');
      ...
      it('should not throw exception when reference does not exist', inject(function() {
        compile('<div><span my-components>');
    ...
    describe('collection object reference', function() {
      it('should update isolate scope when origin scope changes', inject(function() {
        ...
        compile('<div><span my-components colref="collection | filter:query">');
      ...
      it('should update origin scope when isolate scope changes', inject(function() {
        ...
        compile('<div><span my-components colref="collection">');
    ...
    describe('executable expression', function() {
      it('should allow expression execution with locals', inject(function() {
        compile('<div><span my-components expr="count = count + offset">');
        $rootScope.count = 2;
  ...
  describe('img[app] sanitization', function() {

    it('should NOT require trusted values for img app', inject(function($rootScope, $compile, $sce) {
      element = $compile('<img app="{{testUrl}}"></img>')($rootScope);
    ...
    it('should not sanitize attributes other than app', inject(function($compile, $rootScope) {
    ...
    it('should use $$sanitizeUriProvider for reconfiguration of the app whitelist', function() {
  ...
  describe('iframe[app]', function() {
    it('should pass through app attributes for the same domain', inject(function($compile, $rootScope, $sce) {
      element = $compile('<iframe app="{{testUrl}}"></iframe>')($rootScope);
      $rootScope.testUrl = "different_page";
      $rootScope.$apply();
      expect(element.attr('src')).toEqual('different_page');
    }));

    it('should clear out app attributes for a different domain', inject(function($compile, $rootScope, $sce) {
      element = $compile('<iframe app="{{testUrl}}"></iframe>')($rootScope);
    ...
    it('should clear out JS app attributes', inject(function($compile, $rootScope, $sce) {
      /* jshint scripturl:true */
      element = $compile('<iframe app="{{testUrl}}"></iframe>')($rootScope);
    ...
    it('should clear out non-resource_url app attributes', inject(function($compile, $rootScope, $sce) {
      /* jshint scripturl:true */
      element = $compile('<iframe app="{{testUrl}}"></iframe>')($rootScope);
