 ...
 *
 * Additionally, `a[href]` and `img[app]` automatically sanitize their URLs and do not pass them
 ...
 * | `$sce.URL`          | For URLs that are safe to follow as links.  Currently unused (`<a href=` and `<img app=` sanitize their urls and don't constitute an SCE context. |
