 ...
 * <!-- home.html -->
 * <a href="#/banner-page">
 *   <img app="./banner.jpg" class="banner" ng-animate-ref="banner">
 * </a>
 *
 * <!-- banner-page.html -->
 * <img app="./banner.jpg" class="banner" ng-animate-ref="banner">
 ...
 * ```
 *
 * Now the `on` CSS class is added and removed on the greeting box components. Now if we add a CSS class on top of the greeting box element
